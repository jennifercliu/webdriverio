...
describe ('Test whether hidden elements exist', function(){
	...
	it('Button text is visible and exists in html dom therefore should return true', function(done){
		var isEnabled = browser.isExisting('h1');
		console.log(isEnabled);
		expect(isEnabled).to.equal(true);	
	});

	it('There is no such element with the id of #no-such-element within the html dom and therefore should return false', function(done){
